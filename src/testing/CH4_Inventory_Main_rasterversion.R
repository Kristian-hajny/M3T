...
#                                 verbose=TRUE){
  ...
  source(paste0(code_directory,"/testing/Inventory_based_disaggregation_rasterversion.R"))
  ...
  source(paste0(code_directory,"/testing/stationary_combustion_r4_rasterversion.R"))
