...
#'  available at \doi{10.3334/ORNLDAAC/1943} and Vulcan is
#'  available at \doi{10.5281/zenodo.15446748}.
#'
#'  Each fuel-sector-inventory-variation combination is saved separately.
#'
#'  See references for Vulcan at \doi{10.1029/2020JD032974} and ACES at 
